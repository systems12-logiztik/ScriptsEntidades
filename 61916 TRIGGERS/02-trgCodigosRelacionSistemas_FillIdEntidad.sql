/*
  ...
  2           Jaime Astudillo     2026-05-15        AC 55188    Fill IdEntidad from EntityRelations ReferenceId (tipoEntidad CLIENTE)
  */
CREATE
	OR

ALTER TRIGGER [dbo].[trg_CodigosRelacionSistemas_FillIdEntidad] ON [dbo].[CodigosRelacionSistemas]
AFTER INSERT NOT
FOR REPLICATION AS
