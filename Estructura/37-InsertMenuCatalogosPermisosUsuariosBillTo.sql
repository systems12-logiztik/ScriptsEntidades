...
1			JOSE GUERRA			2025-04-23		67468		LAG-CT-004 CatÃ¡logo de Bill-to: pestaÃ±a Usuarios
*/
...
-- Agregar opciÃ³n de insertar para ` Usuarios Bill-to`
...
-- Agregar opciÃ³n de editar para `Usuarios Bill-to`
...
-- Agregar opciÃ³n de listar para `Usuarios Bill-to`
...
-- Agregar opciÃ³n de editar para `General Ejecutivo Comercial Bill-to`
