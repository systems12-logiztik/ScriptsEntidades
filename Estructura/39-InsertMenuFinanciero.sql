...
1			JOSE GUERRA			2025-05-01		67468			Initial Code - Add Permissions to Menu
*/
...
-- Agregar opciï¿½n de listar para `Financiero Bill-to`
...
-- Agregar opciï¿½n de editar deshabilitar para `Financiero Bill-to`
...
-- Agregar opciï¿½n de editar para `Financiero Bill-to`
